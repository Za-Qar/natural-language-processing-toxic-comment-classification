# Toxic Comment Classification (CSCK507 Week 5)
...
## Pipeline Summary
- Data cleaning with regex + spaCy tokenization
...
- Dataset is strongly imbalanced across labels, which impacts rare-class detection
